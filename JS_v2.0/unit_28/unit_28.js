...
let goods = new Goods('apple', 12,'<img src="img/apple128.png">' , 150);
goods.showConsole();
...
let goods2 = new Goods('Яблоко', 12, 'apple128', 150, '.out-4');
goods2.draw();
...
let goods3 = new Goods2('Яблоко', 12, 'apple128', 150, '.out-6', true);
goods3.draw();
...
let valid = new Valid('my_mail@mail.com', 'ty7d2');
valid.validate();
...
let valid22 = new Valid('my_mail@mail.com', 'ty7d2Xp');
valid22.validate();
...
let valid2 = new Valid2('', 't4g2s84ya');
valid2.validate();
console.log(valid2);
...
let valid3 = new Valid2('mymail@mail.com', 'a52pduts64');
valid3.validate();
console.log(valid3);
