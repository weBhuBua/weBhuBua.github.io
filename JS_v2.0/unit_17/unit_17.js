...
function t7() {
    ...
    let out7 = b7.filter(elem => {

        if (typeof (elem) != 'number' && elem.length > 3) {
            b7_res.push(elem);
        }
    })
...
function t8() {
    ...
    let out8 = b8.filter(function (elem, index) {
        if (elem % 2 == 0 ) {
            b8_res.push(index);
        }
    })
