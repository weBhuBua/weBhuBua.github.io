...
// На iOS и Android - клик работает
...
// На iOS и Android - даблклик НЕ работает
...
// На iOS и Android - событие move не работает. Работает клик.
...
// На iOS и Android - событие oncontextmenu не работает.
...
// На iOS и Android - событие onmouseenter не работает. Работает клик в блоке, если предварительно кликнуть вне блока
...
// На iOS и Android - событие onmpuseleave не работает. Работает клик вне блока, если сначала кликнкть в блоке.
...
// На iOS и Android - событие onmouseout не работает. Срабатывает клик вне блока, если сначала кликнкть в блоке.
...
// На iOS и Android - событие onmouseover не работает. При первом клике выводит начальное состояние переменной счетчика.
...
// ваше событие здесь!!!
document.querySelector('.div-10').onmouseleave = t10;

// На iOS и Android - событие onmouseup не срабатывает. Срабатывает клик вне блока, если сначала кликнуть в блоке.active
